...
class uTorrentException(Exception):
    """
...
class uTorrent:
    ...
    def connect(self):
        ...
        try:
            ...
            raise uTorrentException("Unable to Authenticate with utorrent")
        except:
            raise uTorrentException("Unable to connect to utorrent")
        ...
        try:
            ...
            raise uTorrentException("Unable to parse auth token")
    ...
    def _apirequest(self, params, file_field = None, open_file = None):
        ...
        try:
            ...
            raise uTorrentException("Authentication failure. URL: %s" % (url))
        except:
            raise uTorrentException("Unable to connect to uTorrent")
        try:
            parsed = json.loads(response.text)
        except:
            raise uTorrentException("Invalid json received")
    ...
    def prioritize_download(self, torrent_hash):
        ...
        self.set_priority(torrent_hash, uTorrent.P_dont, all_indexes)
        self.start_torrent(torrent_hash)
    ...
    def parse_magnet(self, magnet):
        ...
        try:
            ...
            raise uTorrentException("Malformed magnet URI")
        return magnet_info
